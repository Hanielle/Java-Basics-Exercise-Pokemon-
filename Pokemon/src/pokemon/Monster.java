...
public class Monster {
  ...
  public void attack(Monster m){
      ...
      if(type.equals(m.strongAgainst)){
          damage *= 0.5;
          strong = true;
      }
      if(type.equals(m.weakAgainst)){
          damage *= 2;
          weak = true;
      }
      if(m.guard){
      ...
      if(weak) System.out.println("It was super effective!");
      if(strong) System.out.println("It wasn't very effective...");
